...
; UPDATE NOTES: Updated to remove global references to string parameters "prompt1"
...
.code
main PROC
	PUSH	OFFSET prompt1		;UPDATE: Added this
	PUSH    OFFSET count
...
getCount	PROC
	PUSH    ebp
	MOV     ebp,esp
	MOV     edx, [ebp+12]   ;UPDATE: Changed from MOV edx, OFFSET prompt1
	...
	POP     ebp
	RET     8				;UPDATE: Changed from RET 4
getCount	ENDP
